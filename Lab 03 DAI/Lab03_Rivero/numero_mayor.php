    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top">
            <div class="container-fluid">
                <h3 class="text-white">Calculador del número mayor</h3>
                ...
                <div class="card p-5">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="num3" placeholder="Ingrese un número" required>
                        </div><br>
                        ...
                        <div id="resultados">
                            <?php
                                ...
                                if ($num1 > $num2 && $num1 > $num3 && $num1 != $num2 && $num1 != $num3){
                                    ...
                                    echo "<br><label>Número 3: " . $num3 . "</label>";

                                    echo "<br><br><p>El número mayor es: " . $num1 . "</p>";
                                }if ($num1 < $num2 && $num2 > $num3 && $num2 != $num1 && $num2 != $num3){
                                    echo "<label>Número 1: " . $num1 . "</label>";
                                    echo "<br><label>Número 2: " . $num2 . "</label>";
                                    echo "<br><label>Número 3: " . $num3 . "</label>";

                                    echo "<br><br><p>El número mayor es: " . $num2 . "</p>";
                                }if ($num1 < $num3 && $num2 < $num3 && $num3 != $num1 && $num2 != $num3){
                                    echo "<label>Número 1: " . $num1 . "</label>";
                                    echo "<br><label>Número 2: " . $num2 . "</label>";
                                    echo "<br><label>Número 3: " . $num3 . "</label>";

                                    echo "<br><br><p>El número mayor es: " . $num3 . "</p>";
                                }elseif ($num1 == $num2 || $num2 == $num3 || $num1 == $num3){
                                    echo "Error!! Digite números diferentes.";
                                }
