    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top">
            <div class="container-fluid">
                <h3 class="text-white">Calculadora de suma y producto</h3>
                ...
                <div class="card p-5">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="num4" placeholder="Ingrese un número" required>
                        </div><br>
                        ...
                        <div id="resultados">
                            <?php
                                ...
                                echo "<br><label>Número 4: " . $num4 . "</label>";

                                echo "<br><br><p>La suma de los dos primeros números es: " . $suma . "</p>";
